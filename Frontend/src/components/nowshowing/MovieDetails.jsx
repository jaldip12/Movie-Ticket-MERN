  ...
  return (
    <div className="min-h-screen bg-gray-900">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="w-full md:w-2/3 text-white">
            ...
            <Button 
              ...
              onClick={() => navigate(`/movies/${encodeURIComponent(movie.title)}/booking`)}
            >
              Book Now
            </Button>
          </div>
        ...
        {/* Show Times Preview */}
        <div className="mt-12">
          <h2 className="text-2xl font-bold text-white mb-6">AVAILABLE DATES</h2>
          <div className="flex gap-4 overflow-x-auto pb-4">
            {getDatesFromShows().map((date) => (
              <div
                key={date}
                className="px-6 py-3 rounded-lg whitespace-nowrap bg-gray-800 text-gray-300"
              >
                {date}
              </div>
            ))}
